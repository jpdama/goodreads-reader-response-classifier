...
def main() -> None:
    ...
    parser.add_argument("--train-texts", default=Path("data/processed/train_no_holdout_overlap.csv"), type=Path)
    parser.add_argument("--eval-texts", default=Path("data/processed/test_no_holdout_overlap.csv"), type=Path)
