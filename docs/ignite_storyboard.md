...
|---:|---|---|---|
| 1 | Team member 1 | Ratings do not explain reader response. | Large contrast: star rating vs emotional review snippets. |
| 2 | Team member 1 | We classify what readers feel and what they will do next. | Three signal words: emotions, commitment, recommendation. |
| 3 | Team member 1 | Stakeholder: Underbrush reader insights and recommendation lead. | Simple product workflow. |
| 4 | Team member 1 | Business actions: rank, market, invest, monitor. | Four icons or flow nodes. |
| 5 | Team member 2 | Source: UCSD Goodreads review data. | Dataset scale callout and source note. |
| 6 | Team member 2 | We sampled for rating and length diversity. | Bar/table of sample balance. |
| 7 | Team member 2 | The codebook turns fuzzy emotion into rules. | Codebook excerpt with labels. |
| 8 | Team member 2 | Holdout discipline protects the final evaluation. | Locked holdout diagram. |
| 9 | Team member 3 | Three humans labeled every holdout item. | Agreement workflow. |
